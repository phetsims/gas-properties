...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "FunctionIO.(ArrayIO.<NumberIO>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> ArrayIO.<NumberIO><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
      ...
      "supertype": "ParametricTypeImplIO.<ArrayIO.<NumberIO>, VoidIO>",
      "typeName": "FunctionIO.(ArrayIO.<NumberIO>)=>VoidIO"
    },
    "FunctionIO.(ArrayIO.<NumberIO>,NullableIO.<ArrayIO.<NumberIO>>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> ArrayIO.<NumberIO>, NullableIO.<ArrayIO.<NumberIO>><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "ArrayIO.<NumberIO>",
        "NullableIO.<ArrayIO.<NumberIO>>",
        "VoidIO"
      ],
      "supertype": "ParametricTypeImplIO.<ArrayIO.<NumberIO>, NullableIO.<ArrayIO.<NumberIO>>, VoidIO>",
      "typeName": "FunctionIO.(ArrayIO.<NumberIO>,NullableIO.<ArrayIO.<NumberIO>>)=>VoidIO"
    },
    ...
    "NullableIO.<ArrayIO.<NumberIO>>": {
      ...
      "supertype": "ParametricTypeImplIO.<ArrayIO.<NumberIO>>",
      "typeName": "NullableIO.<ArrayIO.<NumberIO>>"
    },
    "NullableIO.<BooleanIO>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
    ...
    "ParametricTypeImplIO.<ArrayIO.<NumberIO>, NullableIO.<ArrayIO.<NumberIO>>, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<ArrayIO.<NumberIO>, NullableIO.<ArrayIO.<NumberIO>>, VoidIO>"
    },
    "ParametricTypeImplIO.<ArrayIO.<NumberIO>, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<ArrayIO.<NumberIO>, VoidIO>"
    },
    "ParametricTypeImplIO.<ArrayIO.<NumberIO>>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<ArrayIO.<NumberIO>>"
    },
    ...
    "PropertyIO.<ArrayIO.<NumberIO>>": {
      ...
      "supertype": "ParametricTypeImplIO.<ArrayIO.<NumberIO>>",
      "typeName": "PropertyIO.<ArrayIO.<NumberIO>>"
    },
