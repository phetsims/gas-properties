...
export default class Region {
  ...
  // The particles in this region. This does not need to be stateful because CollisionDetector assigns particles to
  // regions after PhET-iO state has been restored.
