...
**Gases Intro**: This sim consists of 2 screen, both of which are based on the _Ideal_ screen.  The _Intro_ screen
...
turned off by default.  See `Options > Pressure Node` or the `pressureNoise` query parameter.
